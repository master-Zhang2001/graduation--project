    ...
    <el-col :xl="24" :lg="24" :md="24" :sm="24" :xs="24" class="mb-8px">
      <el-card shadow="never">
        <el-skeleton :loading="loading" animated>
          <el-row>
            <el-col v-for="(item, index) in projects" :key="`card-${index}`" :xl="4" :lg="4" :md="12" :sm="24" :xs="24" class="ml-42px">
              <el-card shadow="hover" class="mr-8px ml-8px mt-5px" style="height: 100px; width:200px; background-color: #F4F4F5;">
