    ...
    <el-col :xl="24" :lg="24" :md="24" :sm="24" :xs="24" class="mb-8px">
      <el-card shadow="never">
        <el-skeleton :loading="loading" animated>
          <el-row class="flex " style="width: 80%; margin-left:9%">
            <el-col v-for="(item, index) in projects" :key="`card-${index}`" :xl="6" :lg="6" :md="8" :sm="24" :xs="24">
              <el-card shadow="hover" class="mr-8px ml-42px mt-5px"
                style="height: 100px; width:230px; background-color: #F4F4F5;">
